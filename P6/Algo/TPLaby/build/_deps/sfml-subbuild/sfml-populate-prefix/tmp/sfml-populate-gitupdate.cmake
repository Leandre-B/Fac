...
execute_process(
  COMMAND "/usr/sbin/git" --git-dir=.git show-ref "2.6.1"
  WORKING_DIRECTORY "/home/leand/Documents/Fac/P6/Algo/TPLaby/build/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/leand/Documents/Fac/P6/Algo/TPLaby/build/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/leand/Documents/Fac/P6/Algo/TPLaby/build/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
