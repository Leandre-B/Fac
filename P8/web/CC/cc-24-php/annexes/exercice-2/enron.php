...
<head>
    ...
    <title>Enron e-mail viewer</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <header>
        <svg viewBox="0 0 439 433">
            <g>
        ...
        <h2>Enron e-mail viewer</h2>
    </header>
    
    <main>
            <p>Choisissez un fichier contenant des courriels et un motif à rechercher.</p>
            
            <form action="" method="post">    
                <label for="fichier">Fichier:<input type="file" name="fichier" id="fichier" accept=".csv"></label>
                <label for="motif">Motif:<input type="text" name="motif" id="motif"></label>
