...
<body>
    <div>
        <p class="hautsalaire">Haut salaire &gt; 5000</p>
        <p class="bassalaire">Bas salaire &lt;= 5000</p><input type="text" value="Désactivé si âge &gt; 50" disabled />
    </div>
    <?php
    $employees = array(
        ...
        13 => array('id' => '19', 'name' => 'Jermaine Bowman', 'salary' => '6824', 'age' => '94', ), 
        14 => array('id' => '20', 'name' => 'Gabriel Romero', 'salary' => '940', 'age' => '99', ), 
        15 => array('id' => '21', 'name' => 'Roanna Carrillo', 'salary' => '5084', 'age' => '61', ), 
        16 => array('id' => '22', 'name' => 'Wayne Houston', 'salary' => '74', 'age' => '69', ), 
        17 => array('id' => '23', 'name' => 'Yuli Mccarthy', 'salary' => '8820', 'age' => '76', ), 
        18 => array('id' => '24', 'name' => 'Hamilton Stevens', 'salary' => '2958', 'age' => '75', ), 
        19 => array('id' => '25', 'name' => 'Halee Gay', 'salary' => '8932', 'age' => '68', ), 
        20 => array('id' => '26', 'name' => 'Curran Townsend', 'salary' => '927', 'age' => '70', ), 
        21 => array('id' => '27', 'name' => 'Lacy Marks', 'salary' => '8484', 'age' => '28', ), 
        22 => array('id' => '28', 'name' => 'Chaim Bright', 'salary' => '8067', 'age' => '66', ), 
        23 => array('id' => '29', 'name' => 'Byron Gordon', 'salary' => '2793', 'age' => '92', ), 
        24 => array('id' => '30', 'name' => 'Griffin Hickman', 'salary' => '4058', 'age' => '71', ), 
        25 => array('id' => '31', 'name' => 'Lyle Mcmillan', 'salary' => '1083', 'age' => '84', ), 
        26 => array('id' => '32', 'name' => 'Andrew Hess', 'salary' => '7823', 'age' => '25', ), 
        27 => array('id' => '33', 'name' => 'Alice Howe', 'salary' => '489', 'age' => '60', ), 
        28 => array('id' => '34', 'name' => 'Channing Lewis', 'salary' => '4423', 'age' => '61', ), 
        29 => array('id' => '35', 'name' => 'Rashad Harrison', 'salary' => '5598', 'age' => '56', ), 
        30 => array('id' => '36', 'name' => 'Castor Barlow', 'salary' => '1671', 'age' => '37', ), 
        31 => array('id' => '37', 'name' => 'Allistair Riddle', 'salary' => '4557', 'age' => '30', ), 
        32 => array('id' => '38', 'name' => 'Jane Woodard', 'salary' => '9649', 'age' => '64', ), 
        33 => array('id' => '39', 'name' => 'Jerome Flynn', 'salary' => '9881', 'age' => '77', ), 
        34 => array('id' => '40', 'name' => 'Melyssa Hunter', 'salary' => '3315', 'age' => '79', ), 
